...
public static class SpatialMath3D
{
    ...
    public static bool PlanePlaneIntersection(out Vector3 lineP, out Vector3 lineVec, Vector3 plane1Normal, Vector3 plane1Pos, Vector3 plane2Normal, Vector3 plane2Pos)
    {
    ...
    public static bool LinePlaneIntersection(out Vector3 intersection, Vector3 lineP, Vector3 lineVec, Vector3 planeNormal, Vector3 planeP)
    {
    ...
    public static bool ClosestPointsOnTwoLines(out Vector3 closestPLine1, out Vector3 closestPLine2, Vector3 lineP1, Vector3 lineVec1, Vector3 lineP2, Vector3 lineVec2)
    {
    ...
    public static Vector3 ClosestPointOnLineSegment(Vector3 p, Vector3 lineStart, Vector3 lineEnd, bool clampToSegment = true)
    {
