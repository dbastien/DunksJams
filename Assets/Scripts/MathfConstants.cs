...
public static class MathfConstants
{
    ...
    public const float TauDiv5 = Tau / 5.0f;
    ...
    public const float Sqrt2 = 1.41421356237f;              // √2
    public const float Sqrt3 = 1.73205080757f;              // √3
    ...
    public const float ApéryConstant = 1.20206f;            // ζ(3), Apéry's constant
