...
public static class SimplexNoise
{
    ...
    public static float Tiled2D(float x, float y, float tileSize) => Simplex2D(x % tileSize / tileSize, y % tileSize / tileSize);
    public static float Tiled3D(float x, float y, float z, float tileSize) => Simplex3D(x % tileSize / tileSize, y % tileSize / tileSize, z % tileSize / tileSize);
}
