...
{
    public enum CurveType { Float, Vector2, Vector3, Vector4, Quaternion, Color }

    [SerializeField] GameObject selectedGameObject;
    [SerializeField] public ComponentMemberReference memberReference;
    [SerializeField] [NormalizedAnimationCurve] public AnimationCurve curve = new();
    ...
    void CacheApplyMethod()
    {
        ...
        _applyValue = curveType switch                            
        {
            ...
            CurveType.Quaternion => t => memberReference.SetValue(Quaternion.LerpUnclamped(startQuaternion, endQuaternion, t)),
