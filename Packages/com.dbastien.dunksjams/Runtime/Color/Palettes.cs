...
public static class Palettes
{
    ...
    public static readonly Color[] Monokai =
    {
        ...
        new(0.95f, 0.66f, 0.29f),
        new(0.4f, 0.62f, 0.89f),
        new(0.7f, 0.54f, 0.95f),
    ...
    public static readonly Color[] Dracula =
    {
        ...
        new(0.49f, 0.98f, 0.63f),
        new(0.98f, 0.82f, 0.36f),
        new(0.4f, 0.57f, 0.98f),
        new(0.8f, 0.43f, 0.98f),
        new(0.42f, 0.93f, 1f)
    };
    ...
    public static readonly Color[] Nord =
    {
        ...
        new(0.3f, 0.34f, 0.4f),
        new(0.76f, 0.81f, 0.88f),
        new(0.92f, 0.93f, 0.95f),
        new(0.92f, 0.33f, 0.39f),
        new(0.81f, 0.47f, 0.47f),
        new(0.93f, 0.77f, 0.44f),
        new(0.73f, 0.87f, 0.49f),
        new(0.65f, 0.81f, 0.73f),
        new(0.58f, 0.73f, 0.87f),
        new(0.82f, 0.65f, 0.8f)
    };
    ...
    public static readonly Color[] C64 =
    {
        ...
        new(0f, 0.8f, 0.33f),
        new(0f, 0f, 0.67f),
        new(0.93f, 0.93f, 0.47f),
        new(0.87f, 0.53f, 0.33f),
        new(0.4f, 0.27f, 0f),
        new(1f, 0.47f, 0.47f),
        new(0.2f, 0.2f, 0.2f),
        new(0.47f, 0.47f, 0.47f),
        new(0.67f, 1f, 0.4f),
        new(0f, 0.53f, 1f),
    ...
    public static readonly Color[] Arne16 =
    {
        ...
        new(0.88f, 0.44f, 0.55f),
        new(0.62f, 0.62f, 0.62f),
        new(0.64f, 0.39f, 0.13f),
        new(0.92f, 0.54f, 0.19f),
        new(0.97f, 0.89f, 0.42f),
        new(1f, 1f, 1f),
        new(0.11f, 0.15f, 0.2f),
        new(0.18f, 0.28f, 0.31f),
        new(0.27f, 0.54f, 0.1f),
        new(0.64f, 0.81f, 0.15f),
        new(0f, 0.34f, 0.52f),
        new(0.19f, 0.64f, 0.95f),
        new(0.7f, 0.86f, 0.94f)
    };
}