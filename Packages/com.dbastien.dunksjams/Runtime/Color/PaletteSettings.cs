...
{
    [Tooltip("Global default palette. Place this asset under a Resources folder and name it 'PaletteSettings' to be loaded automatically at runtime.")]
    ...
    {
        return Resources.Load<PaletteSettings>("PaletteSettings");
    }
}