...
public class GroundSurface : ScriptableObject
{
    ...
    [SerializeField] private SurfaceType type = SurfaceType.Hard;
    [SerializeField] [Range(0f, 2f)] private float gripMultiplier = 1f;
    [SerializeField] [Range(0f, 1f)] private float dragMultiplier;
    [SerializeField] [Range(0f, 1f)] private float rollingResistanceMultiplier = 1f;
    [SerializeField] private AudioClipReference impactSound;
    [SerializeField] private AudioClipReference rollSound;
