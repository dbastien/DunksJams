...
public static class UIComponents
{
    ...
    {
        GameObject menu = UIBuilder.CreatePanel(parent, "MenuPanel");
        LayoutGroup layout = UIBuilder.CreateLayout(menu.transform, true, 10);
    ...
    {
        GameObject dialog = UIBuilder.CreatePanel(parent, "Dialog", new Vector2(400, 200));
    ...
    {
        GameObject hud = UIBuilder.CreatePanel(parent, "HUDPanel");
        LayoutGroup layout = UIBuilder.CreateLayout(hud.transform, true, alignment: TextAnchor.UpperLeft);
