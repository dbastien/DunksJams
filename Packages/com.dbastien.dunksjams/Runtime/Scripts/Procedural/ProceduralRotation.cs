...
public static class ProceduralRotation
{
    ...
    public static Quaternion RandomVariationAroundAxis
    (
        Quaternion baseRotation, Vector3 axis,
        float maxAngleVariation = 30f
    )
    {
        Quaternion variation = RandomRotationAroundAxis(axis) *
    ...
    (
        Quaternion current, Quaternion target, ref Vector3 currentVelocity,
        float smoothTime
    )
    {
