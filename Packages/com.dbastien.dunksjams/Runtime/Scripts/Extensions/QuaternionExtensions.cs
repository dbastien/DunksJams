...
public static class QuaternionExtensions
{
    public static Quaternion LerpUnclamped(this Quaternion l, Quaternion r, float t)
    {
        ...
        Quaternion result = new(l.x * oneMinusT + r.x * t, l.y * oneMinusT + r.y * t, l.z * oneMinusT + r.z * t, l.w * oneMinusT + r.w * t);
    ...
    public static Quaternion LookRotationSafe(this Quaternion q, Vector3 forward, Vector3 up)
    {
        ...
        if (up.sqrMagnitude < MathConsts.Epsilon_Float || Vector3.Dot(forward.normalized, up.normalized) > MathConsts.Threshold_VectorAlignment)
