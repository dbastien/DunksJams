...
public static class RectExtensions
{
    ...
    {
        var cellWidth = r.width / cols;
        var cellHeight = r.height / rows;
    ...
    {
        var halfWidthA = r.width * 0.5f;
        var halfHeightA = r.height * 0.5f;
        var halfWidthB = other.width * 0.5f;
        var halfHeightB = other.height * 0.5f;

        // current and min non-intersect distances of centers
        var distX = r.xMin + halfWidthA - (other.xMin + halfWidthB);
        var distY = r.yMin + halfHeightA - (other.yMin + halfHeightB);
        var minDistX = halfWidthA + halfWidthB;
        var minDistY = halfHeightA + halfHeightB;
    ...
    {
        var xMin = Mathf.Max(r.xMin, other.xMin);
        var yMin = Mathf.Max(r.yMin, other.yMin);
        var xMax = Mathf.Min(r.xMax, other.xMax);
        var yMax = Mathf.Min(r.yMax, other.yMax);
    ...
    {
        var newWidth = r.width * scale;
        var newHeight = r.height * scale;
