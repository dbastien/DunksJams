...
public static class ConeGenerator
{
    ...
    )
    {
        ...
        float coneH = (new Vector3(radius0, 0f, 0f) - new Vector3(radius1, height, 0f)).magnitude;
        float heightStep = coneH / heightSegments;
        ...
        for (var i = 0; i <= sides; ++i)
        {
            ...
            Vector3 up = (new Vector3(0f, height, 0f) + dir * radius1 - dir * radius0).normalized;
            var h = 0f;
