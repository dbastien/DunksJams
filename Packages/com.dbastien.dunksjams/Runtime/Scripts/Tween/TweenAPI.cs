...
public static class TweenAPI
{
    ...
    private static readonly ObjectPoolEx<Tween<float>> _floatPool = new(16, 256);
    private static readonly ObjectPoolEx<Tween<Vector2>> _vector2Pool = new(16, 256);
    private static readonly ObjectPoolEx<Tween<Vector3>> _vector3Pool = new(16, 256);
    private static readonly ObjectPoolEx<Tween<Color>> _colorPool = new(16, 256);
    private static readonly ObjectPoolEx<Tween<int>> _intPool = new(16, 256);
    private static readonly ObjectPoolEx<Tween<Rect>> _rectPool = new(16, 256);
    private static readonly ObjectPoolEx<Tween<Quaternion>> _quaternionPool = new(16, 256);

    // ===== GENERIC TYPES =====

    // Float tweening
    public static Tween<float> TweenTo
    (
        float startValue, float endValue, float duration, Action<float> setter,
        EaseType easeType
    )
    {
        Tween<float> tween = _floatPool.Get();
    ...
    public static Tween<float> TweenFrom
    (
        float currentValue, float startValue, float duration, Action<float> setter,
        EaseType easeType
    ) =>
    ...
    public static Tween<float> TweenBy
    (
        float currentValue, float offset, float duration, Action<float> setter,
        EaseType easeType
    ) =>
        AddTween(
            new Tween<float>(currentValue, currentValue + offset, duration, null, setter, Mathf.Lerp).
                SetEase(easeType));
    ...
    // Vector2 tweening
    public static Tween<Vector2> TweenTo
    (
        Vector2 startValue, Vector2 endValue, float duration, Action<Vector2> setter,
        EaseType easeType
    )
    {
        Tween<Vector2> tween = _vector2Pool.Get();
    ...
    public static Tween<Vector2> TweenFrom
    (
        Vector2 currentValue, Vector2 startValue, float duration,
        Action<Vector2> setter, EaseType easeType
    )
    {
        Tween<Vector2> tween = _vector2Pool.Get();
    ...
    (
        Vector2 currentValue, Vector2 startValue, float duration,
        Action<Vector2> setter, Func<float, float> customEase
    )
    {
        Tween<Vector2> tween = _vector2Pool.Get();
    ...
    public static Tween<Vector2> TweenBy
    (
        Vector2 currentValue, Vector2 offset, float duration, Action<Vector2> setter,
        EaseType easeType
    )
    {
        Tween<Vector2> tween = _vector2Pool.Get();
    ...
    // Color tweening
    public static Tween<Color> TweenTo
    (
        Color startValue, Color endValue, float duration, Action<Color> setter,
        EaseType easeType
    )
    {
        Tween<Color> tween = _colorPool.Get();
    ...
    public static Tween<Color> TweenFrom
    (
        Color currentValue, Color startValue, float duration, Action<Color> setter,
        EaseType easeType
    )
    {
        Tween<Color> tween = _colorPool.Get();
    ...
    public static Tween<Color> TweenBy
    (
        Color currentValue, Color offset, float duration, Action<Color> setter,
        EaseType easeType
    )
    {
        Tween<Color> tween = _colorPool.Get();
    ...
    // Int tweening
    public static Tween<int> TweenTo
    (
        int startValue, int endValue, float duration, Action<int> setter,
        EaseType easeType
    )
    {
        Tween<int> tween = _intPool.Get();
    ...
    public static Tween<int> TweenFrom
    (
        int currentValue, int startValue, float duration, Action<int> setter,
        EaseType easeType
    )
    {
        Tween<int> tween = _intPool.Get();
    ...
    public static Tween<int> TweenBy
    (
        int currentValue, int offset, float duration, Action<int> setter,
        EaseType easeType
    )
    {
        Tween<int> tween = _intPool.Get();
    ...
    // Quaternion tweening
    public static Tween<Quaternion> TweenTo
    (
        Quaternion startValue, Quaternion endValue, float duration,
        Action<Quaternion> setter, EaseType easeType
    )
    {
        Tween<Quaternion> tween = _quaternionPool.Get();
    ...
    (
        Quaternion startValue, Quaternion endValue, float duration,
        Action<Quaternion> setter, Func<float, float> customEase
    )
    {
        Tween<Quaternion> tween = _quaternionPool.Get();
    ...
    public static Tween<Quaternion> TweenFrom
    (
        Quaternion currentValue, Quaternion startValue, float duration,
        Action<Quaternion> setter, EaseType easeType
    )
    {
        Tween<Quaternion> tween = _quaternionPool.Get();
    ...
    public static Tween<Quaternion> TweenBy
    (
        Quaternion currentValue, Quaternion offset, float duration,
        Action<Quaternion> setter, EaseType easeType
    )
    {
        Tween<Quaternion> tween = _quaternionPool.Get();
        Quaternion targetValue = currentValue * offset;
    ...
    // Rect tweening
    public static Tween<Rect> TweenTo
    (
        Rect startValue, Rect endValue, float duration, Action<Rect> setter,
        EaseType easeType
    )
    {
        Tween<Rect> tween = _rectPool.Get();
    ...
    public static Tween<Rect> TweenFrom
    (
        Rect currentValue, Rect startValue, float duration, Action<Rect> setter,
        EaseType easeType
    )
    {
        Tween<Rect> tween = _rectPool.Get();
    ...
    public static Tween<Rect> TweenBy
    (
        Rect currentValue, Rect offset, float duration, Action<Rect> setter,
        EaseType easeType
    )
    {
        Tween<Rect> tween = _rectPool.Get();
        tween.Initialize(currentValue,
            new Rect(currentValue.x + offset.x, currentValue.y + offset.y, currentValue.width + offset.width,
                currentValue.height + offset.height), duration, null, setter, RectExtensions.Lerp);
        tween.SetEase(easeType);
        return AddTween(tween);
    }
    ...
    )
    {
        ...
        tween.Initialize(currentValue,
            new Rect(currentValue.x + offset.x, currentValue.y + offset.y, currentValue.width + offset.width,
                currentValue.height + offset.height), duration, customEase, setter, RectExtensions.Lerp);
        return AddTween(tween);
    }
    ...
    private static Tween<T> AddTween<T>(Tween<T> tween)
    {
