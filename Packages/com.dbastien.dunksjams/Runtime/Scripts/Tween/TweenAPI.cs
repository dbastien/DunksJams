...
public static class TweenAPI
{
    ...
    static readonly ObjectPoolEx<Tween<float>> _floatPool = new(16, 256);
    static readonly ObjectPoolEx<Tween<Vector2>> _vector2Pool = new(16, 256);
    static readonly ObjectPoolEx<Tween<Vector3>> _vector3Pool = new(16, 256);
    static readonly ObjectPoolEx<Tween<Color>> _colorPool = new(16, 256);
    static readonly ObjectPoolEx<Tween<int>> _intPool = new(16, 256);
    static readonly ObjectPoolEx<Tween<Rect>> _rectPool = new(16, 256);
    static readonly ObjectPoolEx<Tween<Quaternion>> _quaternionPool = new(16, 256);

    // ===== GENERIC TYPES =====

    // Float tweening
    public static Tween<float> TweenTo(float startValue, float endValue, float duration, Action<float> setter,
        EaseType easeType)
    {
    ...
    public static Tween<float> TweenFrom(float currentValue, float startValue, float duration, Action<float> setter,
        EaseType easeType) =>
    ...
    public static Tween<float> TweenBy(float currentValue, float offset, float duration, Action<float> setter,
        EaseType easeType) =>
        AddTween(
    ...
    // Vector2 tweening
    public static Tween<Vector2> TweenTo(Vector2 startValue, Vector2 endValue, float duration, Action<Vector2> setter,
        EaseType easeType)
    {
    ...
    public static Tween<Vector2> TweenFrom(Vector2 currentValue, Vector2 startValue, float duration,
    ...
    public static Tween<Vector2> TweenBy(Vector2 currentValue, Vector2 offset, float duration, Action<Vector2> setter,
        EaseType easeType)
    {
        var tween = _vector2Pool.Get();
    ...
    // Color tweening
    public static Tween<Color> TweenTo(Color startValue, Color endValue, float duration, Action<Color> setter,
        EaseType easeType)
    {
    ...
    public static Tween<Color> TweenFrom(Color currentValue, Color startValue, float duration, Action<Color> setter,
        EaseType easeType)
    {
        var tween = _colorPool.Get();
    ...
    public static Tween<Color> TweenBy(Color currentValue, Color offset, float duration, Action<Color> setter,
        EaseType easeType)
    {
        var tween = _colorPool.Get();
    ...
    // Int tweening
    public static Tween<int> TweenTo(int startValue, int endValue, float duration, Action<int> setter,
        EaseType easeType)
    {
    ...
    public static Tween<int> TweenFrom(int currentValue, int startValue, float duration, Action<int> setter,
        EaseType easeType)
    {
        var tween = _intPool.Get();
    ...
    public static Tween<int> TweenBy(int currentValue, int offset, float duration, Action<int> setter,
        EaseType easeType)
    {
        var tween = _intPool.Get();
    ...
    // Quaternion tweening
    public static Tween<Quaternion> TweenTo(Quaternion startValue, Quaternion endValue, float duration,
    ...
    public static Tween<Quaternion> TweenFrom(Quaternion currentValue, Quaternion startValue, float duration,
        Action<Quaternion> setter, EaseType easeType)
    {
        var tween = _quaternionPool.Get();
    ...
    public static Tween<Quaternion> TweenBy(Quaternion currentValue, Quaternion offset, float duration,
        Action<Quaternion> setter, EaseType easeType)
    {
        var tween = _quaternionPool.Get();
    ...
    // Rect tweening
    public static Tween<Rect> TweenTo(Rect startValue, Rect endValue, float duration, Action<Rect> setter,
        EaseType easeType)
    {
    ...
    public static Tween<Rect> TweenFrom(Rect currentValue, Rect startValue, float duration, Action<Rect> setter,
        EaseType easeType)
    {
        var tween = _rectPool.Get();
    ...
    public static Tween<Rect> TweenBy(Rect currentValue, Rect offset, float duration, Action<Rect> setter,
        EaseType easeType)
    {
        var tween = _rectPool.Get();
