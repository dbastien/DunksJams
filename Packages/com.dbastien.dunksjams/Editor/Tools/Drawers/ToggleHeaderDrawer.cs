...
public class ToggleHeaderDrawer : PropertyDrawer
{
    ...
    {
        ToggleHeaderAttribute toggleHeader = (ToggleHeaderAttribute)attribute;
        ...
        if (toggleProperty != null)
        {
            ...
            toggleProperty.boolValue = EditorGUI.ToggleLeft(position, new GUIContent(toggleHeader.Header), toggleProperty.boolValue, EditorStyles.boldLabel);
        }
        else
        {
