...
{
    private const string RegistryPath = "Packages/com.dbastien.dunksjams/Resources/LutRegistry.asset";
    private const string LutSearchFolder = "Packages/com.dbastien.dunksjams/Runtime/Textures/LDR LUTs";

    [MenuItem("‽/Refresh LUT Registry")]
    public static void DiscoverAndBuild()
    {
        string[] guids = AssetDatabase.FindAssets("t:Texture2D", new[] { LutSearchFolder });
        ...
        names.Clear();
        foreach (Texture2D t in luts) names.Add(t.name);
