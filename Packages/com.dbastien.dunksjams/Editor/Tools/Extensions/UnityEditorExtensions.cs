...
public static class UnityEditorExtensions
{
    ...
    public static Color GetTypeColor(this Object obj) =>
        obj switch
        {
            AnimationClip => new Color(1f, 0.5f, 0.5f),
            AudioClip => new Color(1f, 0.7f, 0.4f),
            Font => new Color(0.8f, 0.8f, 1f),
            GameObject => new Color(0.3f, 0.7f, 1f),
            Material => new Color(0.6f, 1f, 0.6f),
            MonoScript => new Color(1f, 1f, 0.6f),
            ScriptableObject => new Color(1f, 0.92f, 0.6f),
            Shader => new Color(0.6f, 0.8f, 1f),
            Texture => new Color(1f, 0.5f, 1f),
            _ => GUI.color
        };
}