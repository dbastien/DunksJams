...
public static class TextureUtilWrapper
{
    ...
    public static int GetStorageMemorySize(Texture t) => (int)GetStorageMemorySizeMethod.Invoke(null, new object[] {t});
    public static int GetRuntimeMemorySize(Texture t) => (int)GetRuntimeMemorySizeMethod.Invoke(null, new object[] {t});
    public static string GetTextureFormatString(TextureFormat t) => (string)GetTextureFormatStringMethod.Invoke(null, new object[] {t});
}