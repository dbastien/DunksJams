...
public class DialogConversationEditor : Editor
{
    ...
    private void OnEnable() => _conversation = (DialogConversation)target;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Open Graph Editor", GUILayout.Height(40))) DialogGraphWindow.Open(_conversation);
        ...
        if (GUI.changed) EditorUtility.SetDirty(_conversation);
