...
public class RandTests : TestBase
{
    ...
    public void Shuffle_PreservesElements()
    {
        ...
        Rand.Shuffle(list);
        H.Count(list, 5);
        for (var i = 1; i <= 5; i++) H.Contains(list, i);
    }
    ...
    [Test]
    public void FloatRanged_StaysInBounds()
    {
    ...
    [Test]
    public void IntRanged_StaysInBounds()
    {
        for (var i = 0; i < 1000; i++)
    ...
    [Test]
    public void Bool_ReturnsBothValues()
    {
    ...
    [Test]
    public void Element_ReturnsFromArray()
    {
