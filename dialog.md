...
This document outlines the architecture of our custom Dialog System, consolidating features and patterns from industry-standard plugins like **Pixel Crushers' Dialogue System**, **DialogNodeBasedSystem (NBDS)**, **Conversa**, and **DialogGraphEngine**.
...
*   **UX**: **Embedded UI** (TextFields directly in nodes) for inline editing, with **Placeholder Text** to maintain clarity.
